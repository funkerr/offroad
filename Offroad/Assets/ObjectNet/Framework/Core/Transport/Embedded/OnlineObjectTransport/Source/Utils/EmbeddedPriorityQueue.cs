...
namespace com.onlineobject.objectnet.embedded.Utils {
    ...
    {
        /// <summary>Gets the number of elements contained in the <see cref="EmbeddedPriorityQueue{TElement, TPriority}"/>.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="EmbeddedPriorityQueue{TElement, TPriority}"/> class.</summary>
        /// <param name="capacity">Initial capacity to allocate for the underlying heap array.</param>
        public EmbeddedPriorityQueue(int capacity = DefaultCapacity)
        {
            heap = new Entry<TElement, TPriority>[capacity];
            comparer = Comparer<TPriority>.Default;
        }

        /// <summary>Initializes a new instance of the <see cref="EmbeddedPriorityQueue{TElement, TPriority}"/> class with the specified custom priority comparer.</summary>
        /// <param name="comparer">Custom comparer dictating the ordering of elements.</param>
        /// <param name="capacity">Initial capacity to allocate for the underlying heap array.</param>
        public EmbeddedPriorityQueue(IComparer<TPriority> comparer, int capacity = DefaultCapacity)
        {
            heap = new Entry<TElement, TPriority>[capacity];
            this.comparer = comparer;
        }

        /// <summary>Adds the specified element and associated priority to the <see cref="EmbeddedPriorityQueue{TElement, TPriority}"/>.</summary>
        ...
        /// <summary>Removes the lowest priority element from the <see cref="EmbeddedPriorityQueue{TElement, TPriority}"/> and copies it and its associated priority to the <paramref name="element"/> and <paramref name="priority"/> arguments.</summary>
        ...
        /// <returns>true if the element is successfully removed; false if the <see cref="EmbeddedPriorityQueue{TElement, TPriority}"/> is empty.</returns>
        ...
        /// <summary>Removes all elements from the <see cref="EmbeddedPriorityQueue{TElement, TPriority}"/>.</summary>
        public void Clear()
        {
