...
namespace com.onlineobject.objectnet.embedded.Transports.Udp {
    ...
    /// <summary>Provides base send &#38; receive functionality for <see cref="EmbeddedUdpServer"/> and <see cref="EmbeddedUdpClient"/>.</summary>
    public abstract class EmbeddedUdpPeer
    {
        ...
        protected EmbeddedUdpPeer(SocketMode mode, int socketBufferSize)
        {
            ...
            receivedData = new byte[EmbeddedMessage.MaxSize];
        }

        /// <inheritdoc cref="IEmbeddedPeer.Poll"/>
        public void Poll()
        {
            Receive();
        }
        ...
        protected virtual void OnDisconnected(EmbeddedConnection connection, DisconnectReason reason)
        {
