...
namespace com.onlineobject.objectnet.embedded.Utils {
    ...
    public class EmbeddedLogger
    {
        ...
        /// <summary>Initializes <see cref="EmbeddedLogger"/> with all log types enabled.</summary>
        ...
        /// <summary>Initializes <see cref="EmbeddedLogger"/> with the supplied log methods.</summary>
        ...
        public static void Initialize(LogMethod debugMethod, LogMethod infoMethod, LogMethod warningMethod, LogMethod errorMethod, bool includeTimestamps, string timestampFormat = "HH:mm:ss")
        {
            ...
            EmbeddedLogger.includeTimestamps = includeTimestamps;
            EmbeddedLogger.timestampFormat = timestampFormat;
        }
