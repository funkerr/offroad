namespace com.onlineobject.objectnet.embedded.Utils {
    /// <summary>Tracks and manages various metrics of a <see cref="EmbeddedConnection"/>.</summary>
    public class EmbeddedConnectionMetrics
    {
        ...
        public readonly EmbeddedRollingStat RollingReliableSends;
        ...
        public EmbeddedConnectionMetrics()
        {
            Reset();
            ...
            notifyLossTracker = 0;
            notifyBufferCount = 0;
            RollingReliableSends = new EmbeddedRollingStat(64);
        }
