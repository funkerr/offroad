...
namespace com.onlineobject.objectnet.embedded.Utils
{
    ...
    public class EmbeddedConverter
    {
        ...
        /// number which uses the high bit, rendering compression via <see cref="EmbeddedMessage.AddVarULong(ulong)"/> and <see cref="EmbeddedMessage.GetVarULong"/> ineffective.</remarks>
