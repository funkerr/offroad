...
namespace com.onlineobject.objectnet.embedded {
    ...
    public class EmbeddedMessageRelayFilter
    {
        ...
        /// </remarks>
        public EmbeddedMessageRelayFilter(int size) => Set(size);
        /// <summary>Creates a filter based on an enum of message IDs.</summary>
        /// <param name="idEnum">The enum type.</param>
        public EmbeddedMessageRelayFilter(Type idEnum) => Set(GetSizeFromEnum(idEnum));
        ...
        ///     and 8 + 1 = 9) despite the fact that there are only 5 unique message IDs the server will ever handle.
        /// </remarks>
        public EmbeddedMessageRelayFilter(int size, params ushort[] idsToEnable)
        {
            Set(size);
        ...
        public EmbeddedMessageRelayFilter(Type idEnum, params Enum[] idsToEnable)
        {
