...
namespace com.onlineobject.objectnet {
    /// <summary>
    /// Represents a UPnP searcher for discovering network devices.
    /// </summary>
    internal class UpnpSearcher : Searcher {
        ...
        /// <summary>
        /// Initializes a new instance of the UpnpSearcher class with the specified IP address provider.
        /// </summary>
        /// <param name="ipprovider">The IP address provider to use for searching.</param>
        ...
        /// <summary>
        /// Creates a list of UDP clients based on the available unicast addresses.
        /// </summary>
        /// <returns>A list of UDP clients.</returns>
        ...
        /// <summary>
        /// Discovers network devices using the specified UDP client and cancellation token.
        /// </summary>
        /// <param name="client">The UDP client to use for discovery.</param>
        /// <param name="cancelationToken">The cancellation token to stop the discovery process.</param>
        ...
        /// <summary>
        /// Discovers network devices using the specified UDP client, IP address, and cancellation token.
        /// </summary>
        /// <param name="client">The UDP client to use for discovery.</param>
        /// <param name="address">The IP address to use for discovery.</param>
        /// <param name="cancelationToken">The cancellation token to stop the discovery process.</param>
        ...
        /// <summary>
        /// Checks if the specified socket and IP address are valid for communication.
        /// </summary>
        /// <param name="socket">The socket to check.</param>
        /// <param name="address">The IP address to check.</param>
        /// <returns>True if the socket and IP address are valid; otherwise, false.</returns>
        ...
        /// <summary>
        /// Analyzes the received response and returns a NatDevice based on the local address, response data, and endpoint.
        /// </summary>
        /// <param name="localAddress">The local IP address.</param>
        /// <param name="response">The response data received.</param>
        /// <param name="endpoint">The endpoint from which the response was received.</param>
        /// <returns>A NatDevice representing the discovered device, or null if no valid device is found.</returns>
        ...
        /// <summary>
        /// Checks if the specified service type is a valid controller service.
        /// </summary>
        ...
        /// <summary>
        /// Builds a UpnpNatDeviceInfo object based on the local address and location URI.
        /// </summary>
        /// <param name="localAddress">The local IP address.</param>
        /// <param name="location">The location URI of the device.</param>
        /// <returns>An UpnpNatDeviceInfo object representing the device information.</returns>
        ...
        /// <summary>
        /// Reads the XML response from the specified web response and returns an XmlDocument.
        /// </summary>
        /// <param name="response">The web response to read.</param>
        /// <returns>An XmlDocument representing the parsed XML response.</returns>
